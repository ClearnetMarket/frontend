    ...
    <div class="wrapper">
        <div class="container max-w-4xl mx-auto px-2 text-white">
            ...
            <div v-if="page_loaded">
                <div class=" mx-auto mt-5" v-if="userprofile">
                    ...
                    <div class="grid grid-cols-12 gap-4 text-white pb-36">
                        <div class="col-span-12" v-if="userprofile">
                            <div v-if="userprofile.admin_role == 1">
                                <div v-if="vendor_reviews_total > 0">
                                    <div v-for="review in vendorreviews" :key="review.id">
                                        <div class="grid grid-cols-12 bg-neutral rounded-md p-5 mb-2">
                                            ...
                                            <div
                                                class="col-span-12 text-white hover:text-accent hover:underline text-[14px]">
                                                <router-link :to="{
                                                    name: 'MarketItem',
        ...
        getvendorreviews (page: any) {
            axios({
                ...
                .then((response) => {
                    ...
                    if (this.vendorreviews == undefined) {this.vendorreviews = null}
                })
                .catch(() => { });
        },
    },

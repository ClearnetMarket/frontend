    ...
    <MainHeaderBottom />
        ...
        <div class="container max-w-3xl mx-auto px-10 wrapper  overflow-hidden">
            ...
            <div class="rounded-md  mb-5">
                ...
                <div class="pb-5">
                 We are actively watching all tickets and responding as fast as possible.  If you
                 have an account you can create a ticket.
                </div>
            </div>
            ...
            <div class="bg-white rounded-md p-5 mb-5">
                ...
                <div class="pb-5 pt-5">
                     Email:  admin@freeport.com
                </div>
                <div class="">
                    Please include all relevant information when contacting customer support in an email.
                    Account name is mandatory to look into your request.  Do not include your password or seed key.
                </div>
            </div>

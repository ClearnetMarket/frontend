        ...
        <div class="mb-72">
            <div class="bg-neutral rounded-md p-5 mb-5">
                ...
                <div class="">
                    <ul class="list-disc">
                        <li>
                            Not Currently. We do not currently allow this due to how escrow works. In order to keep
                            payments safe and provide transaction protection, we keep the coin in escrow.
                        </li>
                        <li>We would like to implement smart contracts in the future.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bg-neutral rounded-md p-5 mb-5">
                ...
                <div class="">
                    <ul class="list-disc">
                        <li>We do not plan on accepting credit cards or paypal in the near future.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bg-neutral rounded-md p-5 mb-5">
                ...
                <div class="">
                    <ul class="list-disc">
                        <li>We dont allow returns for a few reasons.</li>
                    </ul>
            ...
            <div class="bg-neutral rounded-md p-5 mb-5">
                ...
                <div class="">
                    <ul class="list-disc">
                        <li>
                            We have moderators that will offer a compromise or full refund if they item is not as
                            described.
                        </li>
                    </ul>
                </div>

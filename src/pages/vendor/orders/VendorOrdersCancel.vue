       ...
       <div v-for="order in orders" :key="order.id">
        ...
        <div class="grid grid-cols-12 rounded border border-1 border-gray-300 bg-gray-200 p-5" >
          ...
          <div class="col-span-2 ">
            <button
              class="bg-green-600 m-2 hover:bg-green-400 text-white font-bold py-1 px-3 rounded focus:outline-none 
            ...
            >
              ...
              <button
              class="bg-red-600 m-2 hover:bg-red-400 text-white font-bold py-1 px-3 rounded focus:outline-none 
              focus:shadow-outline w-full"
              type="button"

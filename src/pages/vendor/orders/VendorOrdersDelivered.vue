<template>
  ...
  <div class="max-w-4xl mx-auto wrapper px-10">
    ...
    <div class="grid grid-cols-1 w-full gap-4 mt-5">
      <h1 class="col-span-1 font-semibold text-2xl">Delivered Orders</h1>
            ...
            <div class="grid grid-cols-12 gap-4 bg-red-200">
              <div class="col-span-8 bg-blue-200">
                ...
                <div class="col-span-4">
                  <div class="flex justify-between" v-if="order.digital_currency === 1">
                  ...
                  <div class="flex justify-between" v-if="order.digital_currency === 2">
                  ...
                  <div class="flex justify-between" v-if="order.digital_currency === 3">
                    <div class="">

...
<template>
  ...
  <div class="wrapper">
    <div v-if="user">
      <div class="container max-w-7xl mx-auto wrapper text-white">
        <!-- Container-->
        ...
        <div v-if="transactions" class="px-5 ">
          ...
          <div v-for="t in transactions" class="text-white font-semibold text-[14px] bg-neutral rounded-md">
            ...
            <div v-if="t.category === 1" class="grid grid-cols-12 grid-rows-1 border-b rounded-md p-1 my-5" :key="t.id">
              <div class="col-span-12">{{ relativeDate(t.created) }}</div>
              <div class="sm:col-span-6">Wallet Created</div>
              <div class="col-span-6 sm:col-span-2">--</div>
              <div class="col-span-6 sm:col-span-2">Balance: 0</div>
            </div>
            <!-- WithDrawl -->
            <div v-if="t.category === 2" class="grid grid-cols-12 grid-rows-3 border-b rounded-md p-1 my-5" :key="t.id">
            ...
            <!--#3 = Deposit -->
            <div v-if="t.category === 3" class="grid grid-cols-12 grid-rows-3 border-b rounded-md p-1 my-5" :key="t.id">
              <div class="col-span-12 sm:col-span-2 row-span-1">{{ relativeDate(t.created) }}</div>
              <div class="col-span-12 sm:col-span-6 row-span-3">
                Deposit
              ...
              <div class="col-span-12 sm:col-span-2 row-span-1">
            ...
            <!--#4 = send coin to escrow -->
            <div v-if="t.category === 4" class="grid grid-cols-12 grid-rows-2 border-b p-1 my-5" :key="t.id">
              <div class="col-span-12 sm:col-span-2 row-span-1">{{ relativeDate(t.created) }}</div>
              <div class="col-span-12 sm:col-span-6 row-span-1">
            ...
            <!--#5 = sent coin to user -->
            <div v-if="t.category === 5" class="grid grid-cols-12 grid-rows-2 border-b p-1 my-5" :key="t.id">
              <div class="col-span-12 sm:col-span-2 row-span-1">{{ relativeDate(t.created) }}</div>
            ...
            <!--#6 = Freeport profit -->
            <div v-if="t.category === 6" class="grid grid-cols-12 grid-rows-2 border-b rounded-md p-1 my-5" :key="t.id">
              <div class="col-span-12 sm:col-span-2 row-span-1">{{ relativeDate(t.created) }}</div>
              <div class="col-span-12 sm:col-span-6 row-span-2">
            ...
            <!--#7 = sent coin to holdings -->
            <div v-if="t.category === 7" class="grid grid-cols-4 grid-rows-2 border-b p-1 my-5" :key="t.id">
              <div class="col-span-12 sm:col-span-2 row-span-1">{{ relativeDate(t.created) }}</div>
              <div class="col-span-12 sm:col-span-6 row-span-2">
            ...
            <div v-if="t.category === 8" class="grid grid-cols-12 grid-rows-2 bordered rounded-md p-1 my-5" :key="t.id">
              <div class="col-span-12 sm:col-span-2 row-span-1">{{ relativeDate(t.created) }}</div>
              <div class="col-span-12 sm:col-span-6 row-span-2">
            ...
            <!--#9 = vendor refund -->
            <div v-if="t.category === 9" class="grid grid-cols-12 grid-rows-2 border-b p-1 my-5" :key="t.id">
              <div class="col-span-12 sm:col-span-2 row-span-1">{{ relativeDate(t.created) }}</div>
              <div class="col-span-12 sm:col-span-6 row-span-2">
                Refund from Escrow
                <div v-if="t.order_uuid">

      ...
      <div class="grid grid-cols-1 rounded-md p-6 max-w-3xl mx-auto">
        ...
        ><p v-for="error of v$.$errors" :key="error.$uid">
          ...
          <div class="mb-4">
            ...
            />
            <span
                v-if="v$.CreateItemForm.basicInfo.item_title.$error"
          ...
          <div class="flex gap-5">
            <div class="flex-1 mb-4">
              ...
              <span
                  v-if="v$.CreateItemForm.basicInfo.category_id_0.$error"
                  class="text-red-600 text-center"
              >
            ...
            <div class="flex-1 mb-4">
              ...
              <span
                  v-if="v$.CreateItemForm.basicInfo.item_condition.$error"
                  class="text-red-600 text-center"
              >
